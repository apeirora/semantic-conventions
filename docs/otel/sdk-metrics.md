...
- [Log metrics](#log-metrics)
  ...
  - [Metric: `otel.sdk.log.dropped`](#metric-otelsdklogdropped)
  - [Metric: `otel.sdk.log.attribute.dropped`](#metric-otelsdklogattributedropped)
...
### Metric: `otel.sdk.log.dropped`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.otel.sdk.log.dropped -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `otel.sdk.log.dropped` | Counter | `{log_record}` | The number of logs dropped by processors or exporters. | ![Development](https://img.shields.io/badge/-development-blue) | |

<!-- prettier-ignore-end -->
<!-- END AUTOGENERATED TEXT -->
<!-- endsemconv -->

### Metric: `otel.sdk.log.attribute.dropped`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.otel.sdk.log.attribute.dropped -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `otel.sdk.log.attribute.dropped` | Counter | `{log_attribute}` | The number of log attributes dropped by processors or exporters. | ![Development](https://img.shields.io/badge/-development-blue) | |
